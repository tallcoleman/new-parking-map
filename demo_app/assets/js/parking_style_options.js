  ...
  byQuality: {
    nodes: {
      ...
      paint: {
        "circle-color": [
          "case",
          ["has", "ref:open.toronto.ca:bicycle-parking-high-capacity-outdoor:id"],
          "#49C6B9",
          [
            "match",
            ["get", "bicycle_parking"],
        ...
        "circle-radius": [
          ...
          10,
          ["case", [">", ["to-number", ["get", "capacity"], 0], 4], 5, 3],
          // if capacity > 4 then 16px at zoom 22, else 10px
          22,
          ["case", [">", ["to-number", ["get", "capacity"], 0], 4], 16, 10],
        ],
      },
    },
    ways: {
